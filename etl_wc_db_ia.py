...
# Definições da Base de Dados PostgreSQL Local
USER = 'postgres'    # O usuário do Postgres
PASSWORD = '123456'  # A senha do Postgres
HOST = 'localhost'
PORT = 5432          # Porta padrão do PostgreSQL
DATABASE = 'etl_wc'  # O nome do banco de dados criado no Postgres
...
# CARREGAMENTO (Conexão e envio para o banco local)

string_connection = f'postgresql+psycopg2://{USER}:{PASSWORD}@{HOST}:{PORT}/{DATABASE}'
...
print("Dados enviados com sucesso para a tabela 'ranking_top_3_copas' no PostgreSQL local!")
